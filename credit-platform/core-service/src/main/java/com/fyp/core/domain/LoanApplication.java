...
public class LoanApplication {
    ...
    public static LoanApplication intake(String applicantId, String featuresJson,
                                         InputSource inputSource, String sourceReference,
                                         Instant collectedAt, Instant consentConfirmedAt,
        ...
        a.consentConfirmedAt = consentConfirmedAt;
        a.dataConfirmed = dataConfirmed;
    ...
    public boolean isDataConfirmed() { return Boolean.TRUE.equals(dataConfirmed); }
}
